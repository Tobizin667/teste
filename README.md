...
elseif game.PlaceId == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer:Kick("Não suportado, aguarde...")
end
...
OrionLib:MakeNotification({
	Name = "Next Script",
	Content = "Escolheu um time parceiro?",
...
OrionLib:MakeNotification({
	Name = "Next Script",
	Content = "https://discord.gg/xVSdGzc7SN",
	Image = "rbxassetid://119980140458596",
	Time = 25
})
...
OrionLib:MakeNotification({
    Name = "Next Script",
    Content = "Por favor espere o script carregar, não ative nenhuma função até o carregamento",
    Image = "rbxassetid://119980140458596",
    Time = 5
})
...
W:AddLabel("[+] Next Script para SEMPRE!!")
W:AddLabel("[+] Melhor AutoFarm!")
W:AddLabel("[+] Upe de level outros")
W:AddLabel("[+] Visão")
W:AddLabel("[+] Traduzido para Brasileiro!")
...
local locallv = W:AddLabel("Level")
    ...
    local localstat = W:AddLabel("Pontos")
    ...
    local localDevil = W:AddLabel("Vendedor Frutas")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun: Em breve")
    W:AddLabel("Config Save : Em breve")
    local Farmfast = W:AddLabel("Farm Rápido : ❌")
    local Bypass = W:AddLabel("Autorização ❌")
    local Section = W:AddSection({
        Name = "Mundo"
    })
    ...
    local Section = W:AddSection({
        Name = "Espada Legendaria Checkar"
    })
...
M:AddParagraph("Selecionar Arma","Por favor Selecione uma arma")
...
if World2 and World1 then
    ...
    M:AddParagraph("Resgatar Codigo","Clique no botão para resgatar todos os codigos do Blox Fruits!")
    ...
    local Section = M:AddSection({
        Name = "Automatico Farm Level"
    })


M:AddParagraph("Mente Farm","Clique na caixa do farm, e atualize novo mob para farm!.")

ToggleFarm = M:AddToggle({
    Name = "Automatico farm",
    Default = false,
    Flag = "LevelFarm",
    Save = true,
    Callback = function(Value)
...
M:AddParagraph("Menu de Maestria","Clique na caixa para iniciar farm de maestria")

M:AddToggle({
    Name = "Farm Maestria Blox fruits",
    Default = false,
    Flag = "Maestria",
    Save = true,
    Callback = function(Value)
...
local Section = M:AddSection({
    Name = "Autorização teleporte"
})

M:AddToggle({
    Name = "Autorização Teleporte[BETA]",
    Default = false,
    Flag = "Bypass TP",
    Save = true,
    Callback = function(Value)
...
M:AddToggle({
    Name = "Kaitun[Ko có matar jogadores]",
    Default = false,
    Flag = "Kaitun",
    Save = true,
    Callback = function(Value)
...
M:AddToggle({
    Name = "Para somente no calice sagrado ou chave negra",
    Default = false,
...
spawn(function()
    while wait() do
        pcall(function()
            Bone:Set("Total de ossos : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
        end)
    end
end)

ToggleBone = M:AddToggle({
    Name = "Farmar automatico Ossos",
    Default = false,
    Flag = "Auto Farm Bone",
    Save = true,
    Callback = function(Value)
...
local EliteProgress = M:AddLabel("")
    ...
    M:AddToggle({
        ...
        M:AddToggle({
            Name = "Automatico Aparecimento Katakuri",
            Default = true,
            Callback = function(Value)
        ...
        M:AddToggle({
            Name = "Automatico Katakuri v2[HOP]",
            Default = false,
...
M:AddParagraph("Auto Farm Boss :","Chờ Update thôi ae!!!")
    ...
    local Section = M:AddSection({
        Name = "Observação do Haki"
    })

    M:AddToggle({
        Name = "Automatico farma de observação Haki",
        Default = false,
    ...
    M:AddToggle({
        Name = "Automatico farma de observação Haki[HOP]",
        Default = false,
    ...
    M:AddToggle({
        Name = "Automatico Passos Mortais",
        Default = false,
    ...
    M:AddToggle({
        Name = "Automatico Karate do Homem-Tubarão",
        Default = false,
        Flag = "Auto SharkMan",
        Save = true,
        Callback = function(Value)
 ...
 M:AddToggle({
        Name = "Automatico Garras Eletricas",
        Default = false,
    ...
    M:AddToggle({
        Name = "Automatico Sopro do dragão",
        Default = false,
...
local SaberBoss = IQ:AddLabel("Chefe Saber : ")
spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert") then
                SaberBoss:Set("Chefe Saber : ✅ Spawn")
            else
                SaberBoss:Set("Chefe Saber : ❌ Not Spawn")
            end
        end)
    end
end)
...
local PoleBoss = IQ:AddLabel("Chefe Deus do Trovão : ")
spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") then
                PoleBoss:Set("Chefe Trovão : ✅ Aparecido")
            else
                PoleBoss:Set("Chefe Trovão : ❌ Não Aparecido")
            end
        end)
    end
end)
...
local Section = IQ:AddSection({
    Name = "Proximo Terceiro Mar"
})


IQ:AddToggle({
    Name = "Automatico Terceiro Mar",
    Default = false,
    Flag = "Auto Third",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Automatico Comprar Legendaria Espada",
    Default = false,
    Flag = "Auto Legend",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Automatico Buddy Espada[HOP]",
    Default = false,
    Flag = "Auto Buddy[HOP]",
    Save = true,
    Callback = function(Value)
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Next Script(Noitification)",
                ...
                OrionLib:MakeNotification({
                    Name = "Next Script(Noitification)",
                    Content = "[PT] : Por favor, cancele a missão de nível farrm (se houver)",
                    Image = "rbxassetid://119980140458596",
                    Time = 9
                })
                OrionLib:MakeNotification({
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    OrionLib:MakeNotification({
                        Name = "Next Script BOT",
                        Content = "Você é pontuação maxima!!",
...
spawn(function()
    ...
    if _G.AutoSharkman then
        if Mybeli <= 2500000 or MyFragment <= 5000 then
            ...
            OrionLib:MakeNotification({
                Name = "Next Script BOT",
                Content = "Você não possui Beli ou Fragmentos",
                Image = "rbxassetid://119980140458596",
                Time = 5
            })
            end
            ...
            pcall(function()
                if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
                        ...
                        OrionLib:MakeNotification({
                            Name = "Next Script BOT",
                            Content = "Você não possui SuperHumano",
                            Image = "rbxassetid://14919714384",
                            Time = 5
                        })
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep",true) == 1 then
                        ...
                        OrionLib:MakeNotification({
                            Name = "Next Script BOT",
                            Content = "Você não possui Passo da Morte",
                            Image = "rbxassetid://14919714384",
                            Time = 5
                        })
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true) == 1 then
                        ...
                        OrionLib:MakeNotification({
                            Name = "Next Script BOT",
                            Content = "Você não possui Karate Tubarão-Humano",
                            Image = "rbxassetid://14919714384",
                            Time = 5
                        })
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw",true) == 1 then
                        ...
                        gOrionLib:MakeNotification({
                            Name = "Next Script BOT",
                            Content = "Você Não possui Dragon Talon",
                            Image = "rbxassetid://14919714384",
                            Time = 5
                        })
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon",true) == 1 then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon") and game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon").Level.Value >= 400 or game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon") and game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon").Level.Value >= 400 then
                            if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman",true), "Bring") then
                                OrionLib:MakeNotification({
                                    Name = "Next Script BOT",
                                    Content = "Não Ter Material Suficiente",
                                    Image = "rbxassetid://14919714384",
                                    Time = 5
                                })
                        ...
                        OrionLib:MakeNotification({
                            Name = "Next Script BOT",
                            Content = "Você não possui Respiração do Dragão ",
                            Image = "rbxassetid://14919714384",
                            Time = 5
                        })
    ...
    spawn(function()
        while wait() do
            ...
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                ...
                OrionLib:MakeNotification({
                    Name = "Next Script",
                    Content = "Desligue o Hop Encontre a Lua Por favor",
                    Image = "rbxassetid://119980140458596",
                    Time = 5
                })
...
OrionLib:MakeNotification({
        Name = "Next Script",
        Content = "Carregando script completo!, Agora você pode ativar a função!",
        Image = "rbxassetid://119980140458596",
        Time = 5
    })
...
OrionLib:MakeNotification({
    Name = "Next Script",
    Content = "Carregando Configuração Completa!!",
    Image = "rbxassetid://119980140458596",
    Time = 5
})
